...
(
	...
	(
        ...
        'oncreate_callback'     => array(
            array('Iao\Dca\CreditItems','setDefaultTaxRate'),
            array('Iao\Dca\CreditItems','setDefaultItemUnit')
        ),
...
class CreditItems extends IaoBackend
{
	...
	*/
	...
	public function saveNettoAndBrutto(DataContainer $dc)
	{
        ...
        $parentObj = DB::getInstance()->prepare('SELECT * FROM `tl_iao_credit` WHERE `id`=?')
            ->limit(1)
