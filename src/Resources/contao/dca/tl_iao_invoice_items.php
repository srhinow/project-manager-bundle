...
(
	...
	(
		...
		'oncreate_callback'     => array(
		    array('srhinow.projectmanager.listener.dca.invoice_item','setDefaultTaxRate'),
		    array('srhinow.projectmanager.listener.dca.invoice_item','setDefaultItemUnit')
        ),
		'onload_callback'		=> array
		(
			array('srhinow.projectmanager.listener.dca.invoice_item','setIaoSettings'),
			array('srhinow.projectmanager.listener.dca.invoice_item', 'checkPermission'),
		),
		'onsubmit_callback'	    => array
		(
		    array('srhinow.projectmanager.listener.dca.invoice_item','saveAllPricesToParent'),
		    array('srhinow.projectmanager.listener.dca.invoice_item','saveNettoAndBrutto'),
		    array('srhinow.projectmanager.listener.dca.invoice_item','updateRemaining')
		),
		'sql' => array
		(
			'keys' => array
	...
	(
		...
		(
			...
			'panelLayout'             => '',
			'child_record_callback'   => array('srhinow.projectmanager.listener.dca.invoice_item', 'listItems')
		),
		'label' => array
		(
		...
		(
			...
			(
				...
				'button_callback'     => array('srhinow.projectmanager.listener.dca.invoice_item', 'showPDFButton')
			)
		),
		'operations' => array
		(
			...
			(
				...
				'button_callback'     => array('srhinow.projectmanager.listener.dca.invoice_item', 'toggleIcon')
			),
			'show' => array
			(
			...
			(
				...
				'button_callback'     => array('srhinow.projectmanager.listener.dca.invoice_item', 'addPostenTemplate')
			),
		)
	),
	...
	(
		...
		(
			...
			'flag'                    => 1,
			'inputType'               => 'select',
			'options_callback'        => array('srhinow.projectmanager.listener.dca.invoice_item', 'getItemUnitsOptions'),
		...
		(
			...
			'flag'                    => 1,
			'inputType'               => 'select',
			'options_callback'        => array('srhinow.projectmanager.listener.dca.invoice_item', 'getTaxRatesOptions'),
			'eval'                    => array('tl_class'=>'w50'),
		...
		(
			...
			'flag'                    => 11,
			'inputType'               => 'select',
			'options_callback'        => array('srhinow.projectmanager.listener.dca.invoice_item', 'getPostenTemplate'),
			'eval'                    => array('tl_class'=>'w50','includeBlankOption'=>true,'submitOnChange'=>true, 'chosen'=>true),
			'save_callback' => array
			(
				array('srhinow.projectmanager.listener.dca.invoice_item', 'fillPostenFields')
			),
			'sql'					=> "int(10) unsigned NOT NULL default '0'"
		),
		'published' => array
